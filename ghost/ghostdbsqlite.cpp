...
uint32_t CGHostDBSQLite :: SafelistCount( string server )
{
	uint32_t Count = 0;
	sqlite3_stmt *Statement;
...
bool CGHostDBSQLite :: SafelistCheck( string server, string user )
{
...
bool CGHostDBSQLite :: SafelistAdd( string server, string user )
{
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
bool CGHostDBSQLite :: SafelistRemove( string server, string user )
{
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
bool CGHostDBSQLite :: BanAdd( string server, string user, string admin, string reason )
{
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
bool CGHostDBSQLite :: AccessSet( string server, string user, uint32_t access )
{	
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
uint32_t CGHostDBSQLite :: AccessCheck( string server, string user )
{
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	uint32_t Access = 11;
	sqlite3_stmt *Statement;
...
uint32_t CGHostDBSQLite :: AccessCount( string server, uint32_t access )
{
	uint32_t Count = 0;
	sqlite3_stmt *Statement;
	if( access != 0 )
...
bool CGHostDBSQLite :: AccessRemove( string user )
{
	transform( user.begin( ), user.end( ), user.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
uint32_t CGHostDBSQLite :: CommandAccess( string command )
{
...
bool CGHostDBSQLite :: CommandSetAccess( string command, uint32_t access )
{	
	transform( command.begin( ), command.end( ), command.begin( ), (int(*)(int))tolower );
	bool Success = false;
	sqlite3_stmt *Statement;
...
vector<string> CGHostDBSQLite :: CommandList( uint32_t access )
{
